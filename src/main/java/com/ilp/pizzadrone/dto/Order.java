...
/**
 * defines an order in the PizzaDrones service
 */
public final class Order {
     ...
     */
    public Order(String orderNo, LocalDate orderDate, OrderStatus orderStatus,
                 OrderValidationCode orderValidationCode, int priceTotalInPence,
                 Pizza[] pizzasInOrder, CreditCardInformation creditCardInformation) {
     ...
     * @param creditCardInformation is the credit card to use
     */
    public Order(String orderNo, LocalDate orderDeliveryDate, int priceTotalInPence,
                 Pizza[] pizzasInOrder, CreditCardInformation creditCardInformation) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getOrderNo(), getOrderDate(), getOrderStatus(),
                getOrderValidationCode(), getPriceTotalInPence(), Arrays.hashCode(getPizzasInOrder()));
    }
