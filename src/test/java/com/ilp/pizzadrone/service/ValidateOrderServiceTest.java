 ...
 * validation result matches the expected order status and order validation
 * code.
 */
@SpringBootTest
...
public class ValidateOrderServiceTest {
        ...
        public void setup() {
                ...
                when(retrieveAPIService.fetchRestaurants()).thenReturn(List.of(r1, r2));
        }
        ...
        /**
         * Test /validateOrder endpoint return 200 OK status with max pizza count
         * exceeded
         *
         * @throws Exception if the test fails
         */
        ...
        /**
         * Test /validateOrder endpoint return 200 OK status with different pizza
         * restaurant
         *
         * @throws Exception if the test fails
         */
        @Test
        public void testValidOrderWithMultipleRestaurants() throws Exception {
                mockMvc.perform(post("/validateOrder")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"orderNo\": \"26B2C04C\"," +
                                                "\"orderDate\": \"2024-11-23\"," +
