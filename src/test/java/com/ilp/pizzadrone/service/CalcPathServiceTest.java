...
public class CalcPathServiceTest {
         ...
         * It checks if the fly path is not empty, starts at the restaurant and ends at
         * Appleton Tower
         * It also checks if the fly path does not enter the no-fly zone and has less
         * than the maximum number of moves
         */
        @Test
        ...
        public void testCalculatePath() {
                ...
                for (LngLat point : flyPath) {
                        boolean isInsideNoFlyZone = distanceService
                                        .isInRegionChecker(new IsInRegionRequest(point, noFlyZone));
                ...
                assertTrue(distanceService
                                .isCloseChecker(new LngLatPairRequest(flyPath.getLast(), appletonTowerLocation)),
